// Question data array for the quiz app
// Each object contains:
// - question: The question to be asked (Turkish)
// - options: Array of multiple choice answers (strings)
// - answer: The correct answer (must match one of the options)
// - media: Corresponding image file name (stored in public/images/)
...
const questions = [
  {
    ...
    answer: "Pirinç Unu",
    media: "cin-seddi.jpg", // Related image for visual question context
  },
  {
